...
import { login as authLogin } from '../store/authSlice' // syntax used for changing the default name.
...
function Login() {
    ...
    const {register, handleSubmit} = useForm() // register and handleSubmit is an event.
